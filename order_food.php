    ...
    <form method="post" id="order_food_form" action="order_food.php">
        ...
        <div style="overflow:auto;padding: 30px;">
            <div style="float:right;">
                ...
                <button type="button" class="button_secondary" id="prevBtn" onclick="nextPrev(-1)">Previous</button>
                <button type="button" id="nextBtn" class="button_primary" onclick="nextPrev(1)">Next</button>
            </div>
        </div>
