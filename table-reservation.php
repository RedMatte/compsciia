...
?>
<section style="
    background: url(Design/images/food_pic.webp);
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="number_of_guests">
                            ...
                            <option value="2" <?php echo (isset($_POST['number_of_guests'])) ? "selected" : ""; ?>>Two
                                people</option>
                            <option value="3" <?php echo (isset($_POST['number_of_guests'])) ? "selected" : ""; ?>>
                                Three
                                people</option>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                    <div class="form-group">
                        ...
                        <input type="submit" class="form-control check_availability_submit"
                            name="check_availability_submit" value="Check Availability">
                    </div>
                </div>
            </div>
        </form>
        ...
        if (isset($_POST['check_availability_submit'])) {
            ...
            if ($stmt->rowCount() == 0) {
                ...
                <form method="POST" action="table-reservation.php">
                    ...
                    <div class="form-group">
                        <input type="submit" name="submit_table_reservation_form" class="button_primary"
